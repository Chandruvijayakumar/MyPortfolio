      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <div className="mt-10">
            <button
              type="submit"
              className="block w-full rounded-md bg-current px-3.5 py-2.5 text-center text-sm font-semibold text-background-content shadow-sm hover:bg-accent focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-current"
            >
              Send it
            </button>
          </div>
